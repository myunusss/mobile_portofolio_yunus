...
import 'package:portofolio_yunus/border_color.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ChangeNotifierProvider<BorderColor>(
        create: (context) => BorderColor(),
        child: Scaffold(
          body: SafeArea(
            child: SingleChildScrollView(
              child: Container(
                padding: EdgeInsets.only(bottom: 20),
                child: Consumer<BorderColor>(
                                  ...
                                  child: AnimatedContainer(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        border: Border.all(width: 2, color: borderColor.borderColor),
                          ...
                          child: Column(
                            children: [
                              MenuItem(title: 'About', color: Color(0xFF00A3FF), icon: Icons.info, nextScreen: () {
                                ...
                                borderColor.changeColor(Color(0xFF00A3FF));
                              }),
                              SizedBox(height: 25,),
                              MenuItem(title: 'Education', color: Colors.purple, icon: Icons.cast_for_education, nextScreen: () {
                                ...
                                borderColor.changeColor(Colors.purple);
                              }),
                              SizedBox(height: 25,),
                              MenuItem(title: 'Experience', color: Colors.orange, icon: Icons.explore_rounded, nextScreen: () {
                                ...
                                borderColor.changeColor(Colors.orange);
                              }),
                              // SizedBox(height: 25,),
